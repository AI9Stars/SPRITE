...
def get_prompt(data):
    ...
    objects_info_path = os.path.join(objects_dir,data["objects_path"])
    # print(objects_info_path)
...
def Cot_gen(data):
    ...
    try:
        ...
        image_path = os.path.join(image_dir,data["rgb_dir"])
        # print(image_path)
        response = client.ask_model_muli_image(prompt,image_path)
    except:
        response = "场景存在问题"
...
if __name__ == "__main__":
    ...
    with open("few_shot/meta_info_temp.json","r",encoding= 'utf-8') as f:
