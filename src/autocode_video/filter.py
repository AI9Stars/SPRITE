...
if __name__ =="__main__":
    ...
    for item in data_all:
        ...
        if len(code_res) == 0 or "unable" in code_res or "unknow" in code_res or "无法" in code_res or code_res is None:
            continue

        # if "err" in code_res or "Err" in code_res or "not" in code_res:
        #     continue
